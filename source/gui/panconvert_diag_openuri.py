# Form implementation generated from reading ui file '/Users/apaeffgen/PROG/Python/PanConvert/source/gui/panconvert_diag_openuri.ui'
#
...
class Ui_DialogOpenURI(object):
    def setupUi(self, DialogOpenURI):
        ...
        self.URI = QtWidgets.QPlainTextEdit(parent=DialogOpenURI)
        self.URI.setGeometry(QtCore.QRect(10, 10, 371, 41))
        self.URI.setObjectName("URI")
        self.layoutWidget = QtWidgets.QWidget(parent=DialogOpenURI)
        self.layoutWidget.setGeometry(QtCore.QRect(7, 60, 371, 32))
        self.layoutWidget.setObjectName("layoutWidget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.layoutWidget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.CheckBoxStayOnTop = QtWidgets.QCheckBox(parent=self.layoutWidget)
        ...
        self.ButtonCancel = QtWidgets.QPushButton(parent=self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.ButtonOpenURI = QtWidgets.QPushButton(parent=self.layoutWidget)
