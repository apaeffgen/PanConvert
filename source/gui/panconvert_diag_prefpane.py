# Form implementation generated from reading ui file '/Users/apaeffgen/PROG/Python/PanConvert/source/gui/panconvert_diag_prefpane.ui'
#
...
class Ui_DialogPreferences(object):
    def setupUi(self, DialogPreferences):
        ...
        self.ButtonFromOpml = QtWidgets.QRadioButton(parent=self.BoxFromFormat)
        self.ButtonFromOpml.setGeometry(QtCore.QRect(20, 90, 102, 20))
        self.ButtonFromOpml.setObjectName("ButtonFromOpml")
        self.layoutWidget_2 = QtWidgets.QWidget(parent=self.tab_standard_pref)
        ...
        self.ButtonSave = QtWidgets.QPushButton(parent=self.layoutWidget_2)
        self.ButtonSave.setObjectName("ButtonSave")
        self.horizontalLayout.addWidget(self.ButtonSave)
        self.ButtonCancel = QtWidgets.QPushButton(parent=self.layoutWidget_2)
        self.ButtonCancel.setObjectName("ButtonCancel")
        self.horizontalLayout.addWidget(self.ButtonCancel)
        self.StandardConversion = QtWidgets.QCheckBox(parent=self.layoutWidget_2)
        ...
        self.BatchConversion = QtWidgets.QCheckBox(parent=self.layoutWidget_2)
        self.BatchConversion.setObjectName("BatchConversion")
        self.horizontalLayout.addWidget(self.BatchConversion)
        self.label_LanguageSelector = QtWidgets.QLabel(parent=self.tab_standard_pref)
        ...
        self.label_Pandoc_Path = QtWidgets.QLabel(parent=self.layoutWidget_3)
        self.label_Pandoc_Path.setObjectName("label_Pandoc_Path")
        self.verticalLayout_2.addWidget(self.label_Pandoc_Path)
        self.label_Markdown_Path = QtWidgets.QLabel(parent=self.layoutWidget_3)
        ...
        self.label_Dialog_Path = QtWidgets.QLabel(parent=self.layoutWidget_3)
        self.label_Dialog_Path.setObjectName("label_Dialog_Path")
        self.verticalLayout_2.addWidget(self.label_Dialog_Path)
        self.comboBoxLanguageSelector = QtWidgets.QComboBox(parent=self.tab_standard_pref)
        ...
        self.Button_OldGui = QtWidgets.QRadioButton(parent=self.GuiSelection)
        self.Button_OldGui.setGeometry(QtCore.QRect(10, 30, 171, 20))
        self.Button_OldGui.setObjectName("Button_OldGui")
        self.Tab_Selection = QtWidgets.QGroupBox(parent=self.tab_size_pref)
        self.Tab_Selection.setGeometry(QtCore.QRect(400, 90, 201, 91))
        self.Tab_Selection.setObjectName("Tab_Selection")
        self.Tab_StandardConverter = QtWidgets.QRadioButton(parent=self.Tab_Selection)
